...
try {
    switch ($action) {
        case 'license':
            ...
            // Fast-fail for auto-check
            if ($licenseKey === 'auto-check') {
                sendResponse('error', 'License verification required.');
            }

            if (empty($licenseKey)) {
                sendResponse('error', 'Please enter a license key.');
            }
            sendResponse('success', 'License added successfully.');
            break;
        ...
        case 'install_db':
            ...
            if (empty($host) || empty($name) || empty($user)) {
                sendResponse('error', 'Database credentials missing.');
            }
